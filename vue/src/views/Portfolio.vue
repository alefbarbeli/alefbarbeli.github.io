					...
					<div class="box-items">
						...
						<div class="box-item f-code">
							...
							<div class="desc">
								...
								<a href="#popup-1" class="name has-popup">Vue.js + Rest API + Headless CMS</a>
							</div>
						...
						<div class="box-item f-code">
							...
							<div class="desc">
								<div class="category">Code</div>
								<a href="#popup-2" class="name has-popup">CoreUi + Vue.js + Firebase</a>
							</div>
						...
						<div class="box-item f-webstore">
							...
							<div class="desc">
								...
								<a href="#popup-3" class="name has-popup">Bbauer - Layout Personalizado</a>
							</div>
						...
						<div class="box-item f-integrada">
							...
							<div class="desc">
								...
								<a href="#popup-4" class="name has-popup">Fox Bravo Loja Virtual</a>
							</div>
						...
						<div class="box-item f-webstore">
							...
							<div class="desc">
								<div class="category">Webstore</div>
								<a href="#popup-5" class="name has-popup">Big Hair - Loja Virtual</a>
							</div>
						...
						<div class="box-item f-webstore">
							...
							<div class="desc">
								<div class="category">Webstore</div>
								<a href="#popup-6" class="name has-popup">Frizzon Loja Virtual</a>
							</div>
						...
						<div class="box-item f-woo">
							...
							<div class="desc">
								...
								<a href="#popup-7" class="name has-popup">Lion Of Judah - Loja Virtual</a>
							</div>
						...
						<div class="box-item f-code">
							...
							<div class="desc">
								<div class="category">Code</div>
								<a href="#popup-8" class="name has-popup">Framework Webstore</a>
							</div>
